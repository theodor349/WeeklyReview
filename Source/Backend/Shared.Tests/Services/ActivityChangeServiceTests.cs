...
public class ActivityChangeServiceTests : IClassFixture<WeeklyReviewApiDbFixtureForActivityChangeService>
{
    ...
    [Fact]
    public async Task Change_NoEntry_DoNothing_CaseFoods()
    {
    ...
    [Fact]
    public async Task Change_NoEntry_AddChange_CaseFoods()
    {
        var userGuid = DbFixture.User1;
        var aLunch = 1;
        var aDinner = 2;
    ...
    [Fact]
    public async Task Change_MultipleEntries_OverrideAll_CaseSports()
    {
        var userGuid = DbFixture.User1;
        var aRun = 3;
        var aBike = 4;
    ...
    [Fact]
    public async Task Change_MultipleActivities_OverrideCorrect_CaseTravel()
    {
        var userGuid = DbFixture.User1;
        var aSpain = 5;
        var aItaly = 6;
    ...
    [Fact]
    public async Task Change_FirstDoesNotExist_ThrowError_CaseTravel()
    {
        var userGuid = DbFixture.User1;
    ...
    [Fact]
    public async Task Change_SecondDoesNotExist_ThrowError_CaseTravel()
    {
        var userGuid = DbFixture.User1;
        var aNotExist = 42424242;
        var aFrance = 7;
