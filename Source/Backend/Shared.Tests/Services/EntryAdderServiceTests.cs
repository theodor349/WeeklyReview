...
public class EntryAdderServiceTests : IClassFixture<WeeklyReviewApiDbFixtureForEntryAdderService>
{
    ...
    [Fact]
    public async Task Entry_OnlyEntry_AddEntry_CaseMovies()
    {
        int aSeries = 1;
        int aMovies = 2;
    ...
    [Theory, AutoData]
    public async Task Entry_OnlyEntry_AddEntry_CaseMovies_CheckThatDateIsFlooredTo15Minutes([Range(0, 59)] int minutes)
    {
        int aSeries = 1;
        int aMovies = 2;
    ...
    [Fact]
    public async Task Entry_EntrieArround_AddEntryAndUpdateTimes_CaseFoods()
    {
        int aDinner = 5;
    ...
    [Fact]
    public async Task Entry_EntryAtAndAfter_OverrideEntry_CaseSports()
    {
        int aSwim = 8;
    ...
    [Fact]
    public async Task Entry_EntryAtBeforeAndAfter_InsertingBlank_DeleteEntryAndUpdateTime_CaseTrip()
    {
        var startTime = DbFixture.Dt.AddHours(2);
        var endTime = startTime.AddHours(2);
        var entryDate = startTime.AddHours(1);
