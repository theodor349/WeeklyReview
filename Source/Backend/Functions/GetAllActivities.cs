...
public class GetAllActivities
{
    ...
    [OpenApiOperation(operationId: "GetAllActivities", Summary = "Retrieves all activities for a specific user", Description = "This API retrieves all activities associated with a given user GUID.")]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "GetAllActivities/{userGuid}")] HttpRequest req, [FromRoute] Guid userGuid)
    {
